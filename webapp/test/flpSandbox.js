		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demo2",
									"targetURL": "#fioricicddemo2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioricicddemo2-display": {
								"semanticObject": "fioricicddemo2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioricicddemo2",
									"url": sap.ui.require.toUrl("fioricicddemo2")
								}
							}
						}
					}
